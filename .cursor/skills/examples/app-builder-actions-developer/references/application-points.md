...
| --- | --- | --- | --- | --- | --- |
| **Unified Shell / Firefly Experience Cloud Shell** | `dx/excshell/1` | `src/dx-excshell-1/` | ✓ | ✓ | See `.cursor/skills/app-builder-frontend-developer/references/unified-shell.md` |
