...
| ----------------------------------------------------------- | ----------------------------- | ------------------------------------- | --------------------------------------------------------------------------- |---------------------------------------|
| **Unified shell / Experience shell** (experience.adobe.com) | `src/dx-excshell-1/`          | `src/dx-excshell-1/actions/`          | `src/dx-excshell-1/web-src/`, `src/dx-excshell-1/public/`                   | [unified-shell.md](unified-shell.md) |
